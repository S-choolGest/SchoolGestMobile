 ...
 * @author william
 */
public class ListBiblio_EmpruntForm extends Form{
	Form current;
	ServiceBibliotheque ser = new ServiceBibliotheque();
	
	public ListBiblio_EmpruntForm(Form previous, Utilisateur user) {
		...
		biblio.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				new Emprunt_frontForm(current, user, id).show();
			}
		});
