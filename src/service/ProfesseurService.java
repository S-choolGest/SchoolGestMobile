...
public class ProfesseurService {
    public ConnectionRequest req;
         public static ProfesseurService  instance=null;
        ...
        req = new ConnectionRequest();    
           ...
           public static ProfesseurService getInstance() {
        if (instance == null) {
            instance = new ProfesseurService();
        }
        return instance;
    }  
    ...
    public Absence getAbsence(int id){
        ...
        String url ="http://localhost/SchoolGest/web/app_dev.php/school/ajouterAbs?matiere="+t.getMatiere().getId()+"&date="+t.getDateString(t.getDate())+
